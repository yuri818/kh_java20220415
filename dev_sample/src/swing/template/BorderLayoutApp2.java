...
class BorderLayoutView2 implements ActionListener {
	...
	JButton jbtns2[] = new JButton[5];
	int width = 400;
	int height = 400;
	String jbtn_labels[] = {"send","남쪽","중앙","동쪽","서쪽"};
...
//		jbtns[4] = jbtn_west;
		...
		for(int i = 0; i < loc.length; i++) {
			jbtns2[i] = new JButton(jbtn_labels[i]);
			jbtns2[i].addActionListener(this);
			jf.add(loc[i], jbtns2[i]);
		}
...
public class BorderLayoutApp2 {

	public static void main(String[] args) {
		BorderLayoutView2 blv = new BorderLayoutView2();
