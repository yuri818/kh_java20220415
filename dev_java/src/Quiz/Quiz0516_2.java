...
양수합 : 17
*/
public class Quiz0516_2 {
	//길이가 10인 배열 생성 - 타입은 정수
	int[] arr = new int[10];
	int negsum = 0; //음수의 합
	int possum = 0; //양수의 합
	Quiz0516_2(){ //디폴트생성자로 난수 설정과 출력메세지
		print();
	}
	Quiz0516_2(int[] arr){ //배열의 길이를 다르게 해보기
		this.arr = arr;
		print();
	}
	//-10~10 사이의 난수 설정하기
	...
	public static void main(String[] args) {
		Quiz0516_2 q = new Quiz0516_2(); //디폴트 생성자 호출되므로 난수설정, 메세지 출력
		Quiz0516_2 q2 = new Quiz0516_2(new int[6]); // 배열의 길이를 다르게 해서 실행하는 것
